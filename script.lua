...
local frame = Instance.new("Frame", gui); frame.Size = UDim2.new(0, 240, 0, 160)
...
diamondLabel.Size = UDim2.new(1, -10, 0, 30)
diamondLabel.Position = UDim2.new(0, 5, 0, 5)
diamondLabel.BackgroundTransparency=1
diamondLabel.Text = "Diamonds: 0"
diamondLabel.TextColor3 = Color3.fromRGB(255,255,255)
diamondLabel.Font = Enum.Font.GothamBold; diamondLabel.TextScaled = true

local normalLabel = Instance.new("TextLabel", frame)
normalLabel.Size = UDim2.new(1, -10, 0, 30)
normalLabel.Position = UDim2.new(0, 5, 0, 45)
normalLabel.BackgroundTransparency=1
normalLabel.Text = "Normal Chest: 0"
normalLabel.TextColor3 = Color3.fromRGB(200,255,200)
normalLabel.Font = Enum.Font.GothamBold; normalLabel.TextScaled = true

local strongholdLabel = Instance.new("TextLabel", frame)
strongholdLabel.Size = UDim2.new(1, -10, 0, 30)
strongholdLabel.Position = UDim2.new(0, 5, 0, 85)
...
strongholdLabel.Font = Enum.Font.GothamBold; strongholdLabel.TextScaled = true
        ...
        if g.PlaceId == 126509999114328 then
            ...
            if stronghold then
                ...
                if prox and prox.Enabled then
                    ...
                    if prox and prox.Parent and prox.Enabled then
                        warn("[Farm] Stronghold chest bị khóa, bỏ qua -> farm chest thường")
                    else
                    ...
                    warn("[Farm] Stronghold chest khóa, bỏ qua -> farm chest thường")
                end
            end

            -- sau khi xử lý stronghold -> farm chest thường
            while true do
