...
local function buildUI()
    ...
    -- Gradient đỏ (đậm -> sáng -> đậm)
    local grad = Instance.new("UIGradient")
    grad.Rotation = 90
    grad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0.0, Color3.fromRGB(160, 0, 0)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(230, 20, 20)),
    ...
    makeLabel("ALO KUB", 46, Color3.fromRGB(255,220,220), "Medium")
    makeLabel("Made With Love", 52, Color3.fromRGB(255,200,200), "Medium")

    -- ===== Nút Toggle LUÔN hiển thị (không bị ẩn theo content) =====
    local toggleBtn = Instance.new("TextButton")
    toggleBtn.Name = "ToggleBtn"
    toggleBtn.Size = UDim2.new(0, 64, 0, 40)
    toggleBtn.Position = UDim2.new(0, 24, 0.5, -20) -- bên trái giữa
    toggleBtn.BackgroundColor3 = Color3.fromRGB(120,0,0)
    toggleBtn.Text = "OFF"
    toggleBtn.TextScaled = true
    toggleBtn.TextColor3 = Color3.fromRGB(255,255,255)
    toggleBtn.AutoButtonColor = true
    toggleBtn.Parent = gui -- là SIBLING với content, không nằm trong content
    ...
    local function applyState()
        ...
        if isOn then
            toggleBtn.Text = "OFF"          -- bấm vào để tắt => hiển thị OFF
            toggleBtn.BackgroundColor3 = Color3.fromRGB(120, 0, 0)
        else
            toggleBtn.Text = "ON"           -- bấm vào để bật => hiển thị ON
