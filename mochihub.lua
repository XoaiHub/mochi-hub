...
local configFile = "LonelyHubConfig.json"
...
local Window = Luna:CreateWindow({
    Name = "Lonely Hub",
    Subtitle = nil,
    LogoID = "112485471724320",
    LoadingEnabled = true,
    LoadingTitle = "Lonely Hub",
    LoadingSubtitle = "by LongHip12",
    ConfigSettings = {
        RootFolder = nil,
        ConfigFolder = "Lonely Hub"
    },
})

Window:CreateHomeTab({
    SupportedExecutors = {},
    DiscordInvite = "dBmXyaJhuK",
    Icon = 1,
})
