...
-- Diamonds hiển thị dưới tên tác giả
local diamondText = Instance.new("TextLabel", mainFrame)
diamondText.Size = UDim2.new(1, 0, 0, 35)
diamondText.Position = UDim2.new(0.5, 0, 0, 225) -- dưới "Kaitun 99 Night"
diamondText.AnchorPoint = Vector2.new(0.5, 0)
diamondText.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
diamondText.BackgroundTransparency = 0.5
...
-- Cập nhật số Diamonds (thay DiamondCount.Text bằng biến thật)
task.spawn(function()
    while task.wait(0.2) do
        -- diamondText.Text = "Diamonds: " .. DiamondCount.Text
        diamondText.Text = "Diamonds: 0" -- tạm thời để 0
    end
end)
...
discord.Position = UDim2.new(0.5, 0, 0, 270)
