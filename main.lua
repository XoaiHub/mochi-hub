...
function CheckLevel()
    ...
    if Lv >= 1 and Lv <= 9 then
        ...
        CFrameQuest = CFrame.new(1060.93, 16.42, 1549.17)
        CFrameMon = CFrame.new(1199.31, 16.43, 1570.82)

    elseif Lv >= 10 and Lv <= 14 then
        Mon = "Monkey"
        LevelQuest = 1
        NameQuest = "JungleQuest"
        CFrameQuest = CFrame.new(-1599.81, 36.85, 153.35)
        CFrameMon = CFrame.new(-1448.51, 36.85, 94.65)
    ...
    elseif Lv >= 15 and Lv <= 29 then
        ...
        NameQuest = "JungleQuest"
        CFrameQuest = CFrame.new(-1599.81, 36.85, 153.35)
        CFrameMon = CFrame.new(-1124.24, 40.46, -525.11)

    elseif Lv >= 30 and Lv <= 39 then
        Mon = "Pirate"
        LevelQuest = 1
        NameQuest = "BuggyQuest1"
        CFrameQuest = CFrame.new(-1140.08, 4.75, 3826.52)
        CFrameMon = CFrame.new(-1213.37, 5.15, 3893.03)
    ...
    elseif Lv >= 40 and Lv <= 59 then
        ...
        NameQuest = "BuggyQuest1"
        CFrameQuest = CFrame.new(-1140.08, 4.75, 3826.52)
        CFrameMon = CFrame.new(-1145.81, 16, 4350.13)

    elseif Lv >= 60 and Lv <= 74 then
        Mon = "Desert Bandit"
        LevelQuest = 1
        NameQuest = "DesertQuest"
        CFrameQuest = CFrame.new(896.88, 6.43, 4483.36)
        CFrameMon = CFrame.new(933.05, 6.44, 4489.92)
    ...
    elseif Lv >= 75 and Lv <= 89 then
        ...
        NameQuest = "DesertQuest"
        CFrameQuest = CFrame.new(896.88, 6.43, 4483.36)
        CFrameMon = CFrame.new(1642.4, 10.83, 4371)

    elseif Lv >= 90 and Lv <= 99 then
        Mon = "Snow Bandit"
        LevelQuest = 1
        NameQuest = "SnowQuest"
        CFrameQuest = CFrame.new(1389.42, 87.27, -1297.06)
        CFrameMon = CFrame.new(1341.65, 87.19, -1377.97)
    ...
    elseif Lv >= 100 and Lv <= 119 then
        ...
        NameQuest = "SnowQuest"
        CFrameQuest = CFrame.new(1389.42, 87.27, -1297.06)
        CFrameMon = CFrame.new(1201.73, 105.61, -1447.72)

    elseif Lv >= 120 and Lv <= 149 then
        Mon = "Chief Petty Officer"
        LevelQuest = 1
        NameQuest = "MarineQuest2"
        CFrameQuest = CFrame.new(-5035.74, 28.67, 4324.82)
        CFrameMon = CFrame.new(-4930.15, 65.74, 4121.74)

    elseif Lv >= 150 and Lv <= 174 then
        Mon = "Sky Bandit"
        LevelQuest = 1
        NameQuest = "SkyQuest"
        CFrameQuest = CFrame.new(-4841.56, 717.67, -2622.35)
        CFrameMon = CFrame.new(-4953.05, 365.49, -2894.05)
    ...
    elseif Lv >= 175 and Lv <= 189 then
        ...
        NameQuest = "SkyQuest"
        CFrameQuest = CFrame.new(-4841.56, 717.67, -2622.35)
        CFrameMon = CFrame.new(-5259.43, 389.53, -2272.19)

    elseif Lv >= 190 and Lv <= 209 then
        Mon = "Prisoner"
        LevelQuest = 1
        NameQuest = "PrisonerQuest"
        CFrameQuest = CFrame.new(5305.38, 2.35, 474.63)
        CFrameMon = CFrame.new(5226.72, 0.56, 474.21)
    ...
    elseif Lv >= 210 and Lv <= 249 then
        ...
        NameQuest = "PrisonerQuest"
        CFrameQuest = CFrame.new(5305.38, 2.35, 474.63)
        CFrameMon = CFrame.new(5278.73, 0.58, 758.39)

    elseif Lv >= 250 and Lv <= 274 then
        Mon = "Toga Warrior"
        LevelQuest = 1
        NameQuest = "ColosseumQuest"
        CFrameQuest = CFrame.new(-1576.21, 7.42, -2985.03)
        CFrameMon = CFrame.new(-1820.56, 13.78, -2740.26)
    ...
    elseif Lv >= 275 and Lv <= 299 then
        ...
        NameQuest = "ColosseumQuest"
        CFrameQuest = CFrame.new(-1576.21, 7.42, -2985.03)
        CFrameMon = CFrame.new(-1294.29, 7.23, -3300.26)

    elseif Lv >= 300 and Lv <= 324 then
        Mon = "Military Soldier"
        LevelQuest = 1
        NameQuest = "MagmaQuest"
        CFrameQuest = CFrame.new(-5315.32, 12.24, 8517.34)
        CFrameMon = CFrame.new(-5411.73, 11.08, 8446.79)
    ...
    elseif Lv >= 325 and Lv <= 374 then
        ...
        NameQuest = "MagmaQuest"
        CFrameQuest = CFrame.new(-5315.32, 12.24, 8517.34)
        CFrameMon = CFrame.new(-5805.51, 78.08, 8820.93)

    elseif Lv >= 375 and Lv <= 399 then
        Mon = "Fishman Warrior"
        LevelQuest = 1
        NameQuest = "FishmanQuest"
        CFrameQuest = CFrame.new(61121.17, 19.5, 1568.2)
        CFrameMon = CFrame.new(60755.36, 18.5, 1562.38)
    ...
    elseif Lv >= 400 and Lv <= 449 then
        ...
        NameQuest = "FishmanQuest"
        CFrameQuest = CFrame.new(61121.17, 19.5, 1568.2)
        CFrameMon = CFrame.new(61891.41, 19.3, 1484.3)

    elseif Lv >= 450 and Lv <= 474 then
        Mon = "God's Guard"
        LevelQuest = 1
        NameQuest = "SkyExp1Quest"
        CFrameQuest = CFrame.new(-4620.21, 872.55, -1667.56)
        CFrameMon = CFrame.new(-4698.78, 845.27, -1767.41)
    ...
    elseif Lv >= 475 and Lv <= 524 then
        ...
        NameQuest = "SkyExp1Quest"
        CFrameQuest = CFrame.new(-4620.21, 872.55, -1667.56)
        CFrameMon = CFrame.new(-7685.62, 5567.38, -494.48)

    elseif Lv >= 525 and Lv <= 549 then
        Mon = "Royal Squad"
        LevelQuest = 1
        NameQuest = "SkyExp2Quest"
        CFrameQuest = CFrame.new(-7862.39, 5545.52, -378.01)
        CFrameMon = CFrame.new(-7685.62, 5567.38, -494.48)
    ...
    elseif Lv >= 550 and Lv <= 624 then
        ...
        NameQuest = "SkyExp2Quest"
        CFrameQuest = CFrame.new(-7862.39, 5545.52, -378.01)
        CFrameMon = CFrame.new(-7830.12, 5634.76, -627.23)

    elseif Lv >= 625 and Lv <= 649 then
        Mon = "Galley Pirate"
        LevelQuest = 1
        NameQuest = "FountainQuest"
        CFrameQuest = CFrame.new(5255.54, 38.51, 4050.02)
        CFrameMon = CFrame.new(5553.46, 75.93, 3930.98)

    elseif Lv >= 650 and Lv <= 700 then
        Mon = "Galley Captain"
        LevelQuest = 2
        NameQuest = "FountainQuest"
        CFrameQuest = CFrame.new(5255.54, 38.51, 4050.02)
        CFrameMon = CFrame.new(5677.34, 91.14, 4966.74)
    end
end
...
function CheckBossQuest()
    if First_Sea then
        if SelectBoss == "The Gorilla King" then
            ...
            CFrameBoss = CFrame.new(-1088.76, 8.135, -488.56)
        ...
        elseif SelectBoss == "Bobby" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$8,000\n35,000 Exp."
            CFrameQBoss = CFrame.new(-1140.176, 4.752, 3827.406)
        ...
        elseif SelectBoss == "Yeti" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$10,000\n180,000 Exp."
            CFrameQBoss = CFrame.new(1386.807, 87.273, -1298.358)
            CFrameBoss = CFrame.new(1218.796, 138.012, -1488.026)

        elseif SelectBoss == "Mob Leader" then
            BossMon = "Mob Leader"
            NameBoss = "Mob Leader"
            CFrameBoss = CFrame.new(-2844.731, 7.418, 5356.672)
        ...
        elseif SelectBoss == "Vice Admiral" then
            ...
            QuestLvBoss = 2
            RewardBoss = "Reward:\n$10,000\n180,000 Exp."
            CFrameQBoss = CFrame.new(-5036.247, 28.678, 4324.566)
            CFrameBoss = CFrame.new(-5006.545, 88.032, 4353.162)

        elseif SelectBoss == "Saber Expert" then
            BossMon = "Saber Expert"
            NameBoss = "Saber Expert"
            CFrameBoss = CFrame.new(-1458.895, 29.887, -50.634)
        ...
        elseif SelectBoss == "Warden" then
            ...
            QuestLvBoss = 1
            RewardBoss = "Reward:\n$6,000\n850,000 Exp."
            CFrameQBoss = CFrame.new(5191.861, 2.84, 686.439)
            CFrameBoss = CFrame.new(5278.049, 2.152, 944.102)
        ...
        elseif SelectBoss == "Chief Warden" then
            ...
            RewardBoss = "Reward:\n$10,000\n1,000,000 Exp."
            CFrameQBoss = CFrame.new(5191.861, 2.84, 686.439)
            CFrameBoss = CFrame.new(5206.926, 0.998, 814.977)
        ...
        elseif SelectBoss == "Swan" then
            ...
            RewardBoss = "Reward:\n$15,000\n1,600,000 Exp."
            CFrameQBoss = CFrame.new(5191.861, 2.84, 686.439)
            CFrameBoss = CFrame.new(5325.096, 7.039, 719.571)
        ...
        elseif SelectBoss == "Magma Admiral" then
            ...
            CFrameBoss = CFrame.new(-5765.897, 82.921, 8718.305)
        ...
        elseif SelectBoss == "Fishman Lord" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$15,000\n4,000,000 Exp."
            CFrameQBoss = CFrame.new(61122.652, 18.497, 1569.4)
            CFrameBoss = CFrame.new(61260.152, 30.951, 1193.433)
        ...
        elseif SelectBoss == "Wysper" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$15,000\n4,800,000 Exp."
            CFrameQBoss = CFrame.new(-7861.947, 5545.518, -379.86)
        ...
        elseif SelectBoss == "Thunder God" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$20,000\n5,800,000 Exp."
            CFrameQBoss = CFrame.new(-7903.383, 5635.99, -1410.924)
            CFrameBoss = CFrame.new(-7994.984, 5761.025, -2088.648)
        ...
        elseif SelectBoss == "Cyborg" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$20,000\n7,500,000 Exp."
            CFrameQBoss = CFrame.new(5258.279, 38.527, 4050.045)
            CFrameBoss = CFrame.new(6094.025, 73.77, 3825.735)

        elseif SelectBoss == "Ice Admiral" then
            BossMon = "Ice Admiral"
            NameBoss = "Ice Admiral"
            CFrameBoss = CFrame.new(1266.089, 26.176, -1399.577)

        elseif SelectBoss == "Greybeard" then
            BossMon = "Greybeard"
            NameBoss = "Greybeard"
            CFrameBoss = CFrame.new(-5081.345, 85.222, 4257.359)
        end
    end
end
...
--// Check Boss Quest for Third Sea
if Third_Sea then
    local BossList = {
        ["Stone"] = {
            NameBoss = "Stone",
    ...
    local info = BossList[SelectBoss]
    if info then
        NameBoss = info.NameBoss
        BossMon = info.BossMon
        NameQuestBoss = info.NameQuestBoss
        QuestLvBoss = info.QuestLvBoss
        RewardBoss = info.RewardBoss
        CFrameQBoss = info.CFrameQBoss
        CFrameBoss = info.CFrameBoss
    end
end
...
task.delay(3, function()
    ...
    local success, CombatFramework = pcall(function()
        return require(plr:WaitForChild("PlayerScripts"):WaitForChild("CombatFramework"))
    end)
    if not success or type(CombatFramework) ~= "table" then
        warn("❌ Không thể load CombatFramework.")
        return
    end

    local CbFw = debug.getupvalues(CombatFramework)
    local CbFw2 = CbFw[2]
    if not CbFw2 or not CbFw2.activeController then
        warn("❌ Không tìm thấy activeController.")
        return
    end

    local function GetCurrentBlade()
        local controller = CbFw2.activeController
        if not controller or not controller.blades or #controller.blades == 0 then return nil end
    ...
    print("✅ AttackNoCoolDown đã sẵn sàng.")
