...
-- FastAttack Toggle
local FastToggle = Tabs.Main:AddToggle("FastAttackToggle", {Title = "Fast Attack", Default = true})
...
Fluent:Notify({
    Title = "Loaded",
    Content = "Blox Fruits script loaded with Fluent UI",
    Duration = 5
})
